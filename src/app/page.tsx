...
async function getDashboardStats() {
  ...
  const stats = await dbGet<DashboardStats>(`
    SELECT
      COUNT(*) as totalLoans,
  ...
  const newLoans = await dbGet<{ count: number }>(`
  ...
  return {
    ...
    newLoansCount: newLoans?.count || 0,
            ...
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <Link href="/loans"><DropdownMenuItem>View All Loans</DropdownMenuItem></Link>
                  <Link href="/reports"><DropdownMenuItem>Financial Analysis</DropdownMenuItem></Link>
                </DropdownMenuContent>
              </DropdownMenu>
            </CardHeader>
            <CardContent>
          ...
          <Card className="rounded-[24px] border-none shadow-sm bg-white hover:shadow-md transition-all">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <Link href="/loans?status=ACTIVE"><DropdownMenuItem>View Active Only</DropdownMenuItem></Link>
                  <Link href="/loans/new"><DropdownMenuItem>Create New Loan</DropdownMenuItem></Link>
                </DropdownMenuContent>
              </DropdownMenu>
            </CardHeader>
            <CardContent>
          ...
          <Card className="rounded-[24px] border-none shadow-sm bg-white hover:shadow-md transition-all">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <Link href="/borrowers"><DropdownMenuItem>Manage Borrowers</DropdownMenuItem></Link>
                  <Link href="/borrowers/new"><DropdownMenuItem>Add New Client</DropdownMenuItem></Link>
                </DropdownMenuContent>
              </DropdownMenu>
            </CardHeader>
            <CardContent>
          ...
          <Card className="rounded-[24px] border-none shadow-sm bg-white hover:shadow-md transition-all">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <Link href="/payments/new"><DropdownMenuItem>Record Payment</DropdownMenuItem></Link>
                  <Link href="/reports"><DropdownMenuItem>View Ledger</DropdownMenuItem></Link>
                </DropdownMenuContent>
              </DropdownMenu>
            </CardHeader>
            <CardContent>
            ...
            <Link href="/loans?sort=new" className="col-span-1 block">
              <Card className="rounded-[24px] border-none shadow-sm bg-white p-6 h-full hover:shadow-md transition-all cursor-pointer group">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="px-3 py-1 bg-green-100 text-green-700 font-bold rounded-lg text-sm">This Month</div>
                </div>
              </Card>
            </Link>
            <Link href="/loans?filter=OVERDUE" className="col-span-1 block">
              <Card className="rounded-[24px] border-none shadow-sm bg-white p-6 h-full hover:shadow-md transition-all cursor-pointer group">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="px-3 py-1 bg-red-100 text-red-600 font-bold rounded-lg text-sm">Action Needed</div>
                </div>
              </Card>
            </Link>
          ...
          <div className="col-span-4 space-y-6">
            <Card className="rounded-[30px] border-none bg-black text-white p-8 relative overflow-hidden">
              ...
              <div className="h-3 w-full bg-white/20 rounded-full mb-2 overflow-hidden">
                <div className="h-full bg-white rounded-full transition-all duration-1000" style={{ width: `${Math.min(100, Math.round(((data.totalReceived || 0) / (data.totalLent || 1)) * 100))}%` }}></div>
              </div>
              <div className="text-center text-sm text-gray-400 mb-8">
                Recovery Rate <span className="text-white font-medium">{Math.round(((data.totalReceived || 0) / (data.totalLent || 1)) * 100)}%</span>
              </div>
              <Link href="/reports">
                <Button className="w-full bg-white text-black hover:bg-gray-100 font-bold rounded-xl h-12">View status</Button>
              </Link>
            </Card>
            ...
            <div className="pl-2">
              ...
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  <div className="w-12 h-12 rounded-full bg-black flex items-center justify-center shrink-0"><FileText className="text-white w-5 h-5" /></div>
                  <div><h4 className="font-bold text-base">Run monthly report</h4><p className="text-xs text-gray-400">Mar 4 at 6:00 pm</p></div>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="w-12 h-12 rounded-full bg-black flex items-center justify-center shrink-0"><Clock className="text-white w-5 h-5" /></div>
                  <div><h4 className="font-bold text-base">Check overdue payments</h4><p className="text-xs text-gray-400">Mar 7 at 6:00 pm</p></div>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="w-12 h-12 rounded-full bg-black flex items-center justify-center shrink-0"><Briefcase className="text-white w-5 h-5" /></div>
                  <div><h4 className="font-bold text-base">Approve new loans</h4><p className="text-xs text-gray-400">Mar 12 at 6:00 pm</p></div>
                </div>
                <div className="flex gap-4 items-start">
                  <div className="w-12 h-12 rounded-full bg-black flex items-center justify-center shrink-0"><CheckCircle2 className="text-white w-5 h-5" /></div>
                  <div><h4 className="font-bold text-base">Finish auditing</h4><p className="text-xs text-gray-400">Mar 12 at 6:00 pm</p></div>
                </div>
              </div>
            </div>
            ...
            <Card className="rounded-[30px] border-none bg-black text-white p-6 relative overflow-hidden mt-6">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">You have been invited to attend a meeting of the Associaton.</p>
            </Card>
          </div>
        </div>
      </main>
